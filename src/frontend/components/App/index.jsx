...
function App(props) {
	...
	return (
		<div>
			...
			<footer class="footer">
				<a href="https://sciunit.run/" style={{fontStyle: "bold", fontSize: "1.2rem", paddingLeft:".5rem .5rem!important"}}>Sciunit Home</a>		<a href="https://sciunit.run/docs/" style={{fontSize: "22px", paddingLeft:"20px"}}>Documentaion</a><br/>
