...
function App(props) {
	...
	return (
		<div>
			...
			<footer class="footer">
				<div>
					<a href="https://sciunit.run/" style={{fontWeight:"bold", fontSize: "1.15rem", paddingLeft:".5rem .5rem!important"}}>Sciunit Home</a>
					<a href="https://sciunit.run/docs/" style={{fontSize: "22px", paddingLeft:"20px"}}>Documentaion</a>
				</div>
