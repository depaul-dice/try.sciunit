		...
		<div>
			<div className="content-body">
				...
				<div className="commandDetail" value={cmd_id} ref={(input) => { detail_ref = input; }}>
					...
					<hr/>
					<div>
						<span style={{fontFamily:"Inconsolata", fontWeight:"20px"}}>{cmd_detail[cmd_id].sciunit_1}</span>{cmd_detail[cmd_id].description_1}<span style={{fontFamily:"Inconsolata"}}>{cmd_detail[cmd_id].sciunit_1_1}</span> <br/>
